...
/**
 * Repository interface for `WeeklyKpis` entities in the analytics query service.
...
public interface WeeklyKpisRepository extends JpaRepository<WeeklyKpis, Long> {
    ...
    /**
     * Finds a list of `WeeklyKpis` records within a specified date range.
     * @param startDate The start date of the range (inclusive).
     * @param endDate The end date of the range (inclusive).
     * @return A list of `WeeklyKpis` records within the specified date range.
     */
    List<WeeklyKpis> findByWeekStartDateBetween(Date startDate, Date endDate);
}
